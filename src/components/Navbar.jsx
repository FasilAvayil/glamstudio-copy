                        ...
                        <div className="px-4 pt-4 pb-8 space-y-4">
                            ...
                            <div className="flex justify-center pt-4">
                                <button
                                    ...
                                    className="w-full py-3 bg-glam-gold text-black font-bold tracking-widest hover:bg-white transition-colors flex items-center justify-center gap-2"
                                >
