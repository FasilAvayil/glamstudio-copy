                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="flex space-x-3">
                            <SocialIcon
                                icon={<Facebook size={18} className="text-white fill-white/20" />}
                                href="#"
                                color="#1877F2"
                            />
                            <SocialIcon
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400 text-sm">
                            ...
                            <FooterLink text="About Us" href="#about" />
                             ...
                             <FooterLink text="Contact" href="tel:+919980658535" />
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400 text-sm">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span>+91 9980658535</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="h-5 w-5 text-red-500 shrink-0" />
                                <span>contactglamzstudio@gmail.com</span>
                            </li>
                        </ul>
...
const SocialIcon = ({ icon, href, color, gradient }) => (
    <motion.a
        href={href}
        target="_blank"
        ...
        whileTap={{ scale: 0.9 }}
        viewport={{ once: true }}
        className="w-10 h-10 rounded-full flex items-center justify-center relative overflow-hidden group shadow-lg border border-white/10"
        style={{
...
const FooterLink = ({ text, href }) => (
    ...
    <li>
        <a href={href || `#${text.toLowerCase().replace(' ', '-')}`} className="hover:text-glam-gold transition-colors duration-300">
            {text}
        </a>
    </li>
);
